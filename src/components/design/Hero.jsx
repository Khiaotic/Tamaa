...
const Rings = () => {
  return (
    <>
      <div className="absolute top-1/2 left-5 w-[65.875rem] aspect-square border border-n-2/10 rounded-full -translate-x-1/2 -translate-y-[calc(80%-800px)]" />
      <div className="absolute top-1/2 left-1/2 w-[51.375rem] aspect-square border border-n-2/10 rounded-full -translate-x-40 -translate-y-[calc(80%-1000px)]" />
      <div className="absolute top-1/2 left-1/2 w-[36.125rem] aspect-square border border-n-2/10 rounded-full -translate-x-1/2 -translate-y-[calc(80%-880px)]" />
      <div
        className="absolute top-1/2 left-1/2 w-[23.125rem] aspect-square border border-n-2/10 rounded-full -translate-x-1/2 -translate-y-[calc(80%-8
        0px)]"
      />
    </>
  );
