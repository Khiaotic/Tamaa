  ...
  return (
    <Section id="assets">
        <div className="container ">
            ...
            <Heading title="Downloadable Assets" text="assets for content creation {created by KHIAOTIC}"/>
            </div>
...
<div className='bg-blue-600 relative z-1 grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-4 p-8 border border-n-[1/10] rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
    {[
        {src: TamaSketchyGif, alt: 'Tama Sketchy Gif', width:300, height:300, name:'tamasketchygif.gif'},
        {src: TamaLogoNameSide, alt: 'Tama Logo Side', width:800, height:800, name:'tamaLogoNameSide.png'},
        {src: TamaLogoNameMiddle, alt: 'Tama Logo Middle', width:800, height:800, name:'tamaLogoNameMiddle.png'},
        {src: TamaHero, alt: 'TamaHero', width:800, height:800, name:'TamaHero.jpg', colspan:2, rowSpan:2},
...
<button className='text-white font-nunito bg-pink-400 px-4 py-2 rounded'>DOWNLOAD</button>
    </div>
</a>
            </div>
    ))}
